...
- Calibration Lab demonstrates probability calibration with reliability diagrams, score distributions, raw-vs-scaled scores, accuracy@0.5, Brier score, ECE, calibration gap error bars, and temperature scaling.
