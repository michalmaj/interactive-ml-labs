"""Minimal Pygame visualization for the Gradient Descent Playground demo."""
...
class GradientDescentPygameApp:
    ...
    def _draw(self) -> None:
        """Draw the full application frame."""
        ...
        self._draw_main_plot(self._snapshot)
        self._draw_side_panel(self._snapshot)
    ...
    def _draw_side_panel(self, snapshot: AlgorithmSnapshot) -> None:
