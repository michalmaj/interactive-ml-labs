...
Kolejne dema będą podpinane stopniowo. Gradient Descent Playground, k-NN Vote Map i Boosting Mistake Lab działają już w unified app, a każde demo nadal można uruchomić osobno.
