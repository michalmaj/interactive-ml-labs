...
- Calibration Lab: reliability diagrams, score distributions, raw-vs-scaled scores, accuracy@0.5, Brier score, Expected Calibration Error, worst gap, and temperature scaling,
...
- Calibration Lab, with overconfident, underconfident, and better calibrated presets, a reliability diagram, score distribution, raw-vs-scaled score reference, accuracy@0.5, Brier score, ECE, worst-gap highlighting, calibration gap error bars, and temperature scaling.
